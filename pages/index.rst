...
+===================================================+=========+============+========+
| `Download <https://7-zip.org/a/7z1900.exe>`__     | .exe    | 32-bit x86 | 1,2 MB |
+---------------------------------------------------+---------+------------+--------+
| `Download <https://7-zip.org/a/7z1900-x64.exe>`__ | .exe    | 64-bit x64 | 1,4 MB |
+---------------------------------------------------+---------+------------+--------+
...
| Link                                                | Version | Windows      | Größe  |
+=====================================================+=========+==============+========+
| `Download <https://7-zip.org/a/7z2002.exe>`__       | .exe    | 32-bit x86   | 1,2 MB |
+-----------------------------------------------------+---------+--------------+--------+
| `Download <https://7-zip.org/a/7z2002-x64.exe>`__   | .exe    | 64-bit x64   | 1,4 MB |
+-----------------------------------------------------+---------+--------------+--------+
| `Download <https://7-zip.org/a/7z2002-arm64.exe>`__ | .exe    | 64-bit ARM64 | 1,5 MB |
+-----------------------------------------------------+---------+--------------+--------+
